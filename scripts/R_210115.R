...
#para realizar los heatmaps, se van a utilizar los archivos generado a partir de DESeq, utilizando el programa GENE_E en http://www.broadinstitute.org/cancer/software/GENE-E/